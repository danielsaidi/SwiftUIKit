...
public struct DragGestureButton<Label: View>: View {
    ...
    /**
     ...
     - Parameters:
       ...
       - longPressDelay: The time it takes for a press to count as a long press, by default ``DragGestureButtonDefaults/longPressDelay``.
       - longPressAction: The action to trigger when the button is long pressed, by default `nil`.
       - doubleTapTimeout: The max time between two taps for them to count as a double tap, by default ``DragGestureButtonDefaults/doubleTapTimeout``.
       - doubleTapAction: The action to trigger when the button is double tapped, by default `nil`.
       - repeatDelay: The time it takes for a press to count as a repeat trigger, by default ``DragGestureButtonDefaults/repeatDelay``.
    ...
    init(
        ...
        longPressDelay: TimeInterval = DragGestureButtonDefaults.longPressDelay,
        longPressAction: Action? = nil,
        doubleTapTimeout: TimeInterval = DragGestureButtonDefaults.doubleTapTimeout,
        doubleTapAction: Action? = nil,
        repeatDelay: TimeInterval = DragGestureButtonDefaults.repeatDelay,
...
@available(iOS 14.0, macOS 11.0, watchOS 8.0, *)
private extension DragGestureButton {
...
/**
 ...
 the ``DragGestureButton`` gesture configurations.
 */
@available(iOS 14.0, macOS 11.0, watchOS 8.0, *)
public struct DragGestureButtonDefaults {
...
@available(iOS 14.0, macOS 11.0, watchOS 8.0, *)
struct DragGestureButton_Previews: PreviewProvider {
